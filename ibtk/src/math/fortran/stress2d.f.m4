c
c     Routines to compute discrete stress on patches.
c
c     Created on 27 Jan 2016 by Nishant Nangia
c
...
c
c     Computes W = stress u = 0.5*(du1/dx0 + du0/dx1).
c
